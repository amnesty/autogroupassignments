 ...
 */
class CRM_AutoGroupAssignments_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_AutoGroupAssignments_Upgrader(
        'org.amnesty.es.autogroupassignments',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_AutoGroupAssignments_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
